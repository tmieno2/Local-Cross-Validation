...
This process is repeated multiple times to create more folds. @tbl-fold-repeat presents the the complete set of combinations of the number of folds and repeats that are tried in our simulation analysis. As our main results, we present the results with case 5 (# of folds = 10 and # of repeats = 5) in @sec-results-main. In @sec-results-sensitivity-fold-repeat, how the choice of fold-repeat affect the performance of the model selection approaches.
