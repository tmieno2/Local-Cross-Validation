...
```{r fig.id = "fig-2", fig.cap = "spatial_illustration", fig.width = 5, fig.width = 4, dpi = 400}
pCorn <- 6.25 / 25.4 # $/kg
pN <- 1 / 0.453592 # $/kg
...
knitr::include_graphics(here( "mean_of_true_rmse_and_profit.jpg"))
...
knitr::include_graphics(here( "t2.jpg"))
...
knitr::include_graphics(here( "t3.jpg"))
