...
theme_fig <-
  ...
  theme(
    axis.title.x =
      element_text(
        size = 12, angle = 0, hjust = .5, vjust = -0.3, family = "Helvetica"
      ),
    axis.title.y =
      element_text(
        size = 12, angle = 90, hjust = .5, vjust = .9, family = "Helvetica"
      ),
    axis.text.x =
      element_text(
        size = 9, angle = 0, hjust = .5, vjust = 1.5, family = "Helvetica"
      ),
    axis.text.y =
      element_text(
        size = 9, angle = 0, hjust = 1, vjust = 0, family = "Helvetica"
      ),
    axis.ticks =
      element_line(
    ...
    legend.text =
      element_text(
        size = 12, angle = 0, hjust = 0, vjust = 0.5, family = "Helvetica"
      ),
    legend.title =
      element_text(
        size = 12, angle = 0, hjust = 0, vjust = 0, family = "Helvetica"
      ),
    legend.key.size = unit(0.5, "cm"),
    #--- strip (for faceting) ---#
    strip.text = element_text(size = 9, family = "Helvetica"),
    #--- plot title ---#
...
ggsave(
  "writing/FiguresTables/g_ranking.png",
  g_ranking,
  width = 6,
  height = 3.5,
  dpi = 400
...
saveRDS(main_accuracy_table, here::here("writing/FiguresTables/main_selection_accuracy_table.rds"))

saveRDS(accuracy_table, here::here("writing/FiguresTables/selection_accuracy_table.rds"))
```
...
ggsave(
  here::here("writing/FiguresTables/g_pi_loss.png"),
  g_pi_loss,
  dpi = 300,
  width = 6,
  height = 3.5
...
ggsave(
  here::here("writing/FiguresTables/g_sensitivity_fold_repeat.png"),
  g_sensitivity_fold_repeat,
  width = 6,
  height = 6,
  dpi = 300
...
ggsave(
  here::here("writing/FiguresTables/g_leonr_comp.png"),
  g_leonr_comp,
  dpi = 300,
  height = 5,
  width = 6
...
ggsave(
  here::here("writing/FiguresTables/g_gam_leonr.png"),
  g_gam_leonr,
  dpi = 300,
  height = 3.5,
  width = 6
...
saveRDS(accuracy_table, here::here("writing/FiguresTables/selection_accuracy_table_no_sp.rds"))
```
...
ggplot2::ggsave(
  here::here("writing/FiguresTables/g_split_example.png"),
  g_split_example,
  dpi = 300,
  height = 6,
  width = 6
...
<<<<<<< HEAD:code/3_present_results.qmd
=======
...
#--- train or test ---#
train_test_split_q <-
  readRDS(here::here("Shared/Results/sim_results_num_repeats_1_num_folds_10/train_test_split.rds"))
...
ggplot2::ggsave(
  here::here("GitControlled/Writing/FiguresTables/g_split_example_10_folds.png"),
  g_split_example_10_folds,
  dpi = 300,
  height = 6,
  width = 6
...
```
>>>>>>> Local-Cross-Validation/main:Codes/3_present_results.qmd
