...
```{r}
# spatial_cross_validation_example_map 
...
# run function for each fold and store the plots in the list
for (fold in 1:5) {
...
spatial_cross_validation_example_map <- final_plot_q +
...
print(spatial_cross_validation_example_map)

ggplot2::ggsave(
  here::here("GitControlled/Writing/FiguresTables/spatial_cross_validation_example_map.png"),
  spatial_cross_validation_example_map,
  dpi = 300,
  height = 5,
  width = 10
